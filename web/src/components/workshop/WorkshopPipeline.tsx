          ...
          return (
            <section key={column.code} className="rounded-md border border-slate-200 bg-slate-50 p-3">
              ...
              <div className="space-y-3">
                {columnInterventions.length === 0 ? <p className="rounded-md border border-dashed border-slate-200 bg-white p-3 text-xs text-slate-500">Aucun vehicule dans cette etape.</p> : null}
