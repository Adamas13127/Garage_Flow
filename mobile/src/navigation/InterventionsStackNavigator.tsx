...
export function InterventionsStackNavigator() {
  return <Stack.Navigator><Stack.Screen name="InterventionsList" component={InterventionsScreen} options={{ headerShown: false, title: 'Reparations' }} /><Stack.Screen name="InterventionDetail" component={InterventionDetailScreen} options={{ title: 'Suivi reparation' }} /></Stack.Navigator>;
}
