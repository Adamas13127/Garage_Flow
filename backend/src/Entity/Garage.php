...
return $this;
    ...
    {
        if ($this->users->removeElement($user) && $user->getGarage() === $this) {
            $user->setGarage(null);
        }
...
return $this;
    ...
    {
        if ($this->openingHours->removeElement($openingHour) && $openingHour->getGarage() === $this) {
...
return $this;
    ...
    {
        if ($this->unavailabilities->removeElement($unavailability) && $unavailability->getGarage() === $this) {
...
return $this;
    ...
    public function getServicePrestations(): Collection
    {
        return $this->servicePrestations;
    }

    public function addServicePrestation(ServicePrestation $servicePrestation): static
    {
        if (!$this->servicePrestations->contains($servicePrestation)) {
            $this->servicePrestations->add($servicePrestation);
...
return $this;
    ...
    {
        if ($this->servicePrestations->removeElement($servicePrestation) && $servicePrestation->getGarage() === $this) {
...
return $this;
    ...
    {
        if ($this->appointments->removeElement($appointment) && $appointment->getGarage() === $this) {
...
return $this;
    ...
    {
        if ($this->actionLogs->removeElement($actionLog) && $actionLog->getGarage() === $this) {
