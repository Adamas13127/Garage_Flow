...
class InterventionStatus
{
    ...
    public function isVisibleClient(): bool
    {
        return $this->visibleClient;
    }

    public function setVisibleClient(bool $visibleClient): static
    {
...
return $this;
    ...
    {
        if ($this->interventions->removeElement($intervention) && $intervention->getStatutActuel() === $this) {
...
return $this;
    ...
    public function addHistory(InterventionStatusHistory $history): static
    {
...
return $this;
    ...
    {
        if ($this->histories->removeElement($history) && $history->getStatus() === $this) {
