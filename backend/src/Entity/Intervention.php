...
class Intervention
{
    ...
    public function getStatutActuel(): ?InterventionStatus
    {
        return $this->statutActuel;
    }

    public function setStatutActuel(?InterventionStatus $statutActuel): static
    {
    ...
    public function getNotesResume(): ?string
    {
        return $this->notesResume;
    }

    public function setNotesResume(?string $notesResume): static
    {
        $this->notesResume = $notesResume;
    ...
    public function addStatusHistory(InterventionStatusHistory $history): static
    {
    ...
    {
        if ($this->statusHistories->removeElement($history) && $history->getIntervention() === $this) {
    ...
    {
        if ($this->internalNotes->removeElement($note) && $note->getIntervention() === $this) {
    ...
    {
        if ($this->notifications->removeElement($notification) && $notification->getIntervention() === $this) {
